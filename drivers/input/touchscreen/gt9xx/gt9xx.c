...
static int goodix_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    struct pinctrl          *rest_pin_ctrl;
    struct pinctrl_state    *rest_pin_pullup;
    ...
    //pull up rest pin
    rest_pin_ctrl = devm_pinctrl_get(&i2c_connect_client->dev); 
    rest_pin_pullup = pinctrl_lookup_state(rest_pin_ctrl, "default");
    pinctrl_select_state(rest_pin_ctrl, rest_pin_pullup);
